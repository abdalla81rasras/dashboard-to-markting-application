      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseGFRUITS" class="collapse" style="margin-top: 0.50px;" aria-labelledby="headingGFRUITS" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="Add_Green_Fruits.php">Add Green Fruits</a>
          </div>
        </div>
      </li>
      <li class="nav-item my-1">
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_green" value="<?php echo $id_green; ?>">
            <div class="row m-2">
                    ...
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputName">Name Green Fruit :</label>
                          <input type="text" name="name_green" id="InputName" class="form-control" value="<?php echo htmlspecialchars($name_green); ?>" placeholder="Enter Name ...">
                          <div class="text-secondary pt-3"><?php echo $errors['name_green'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputPrice">Price Green Fruit :</label>
                          <input type="number" name="price_green" id="InputPrice" class="form-control" min="0" step="0.00001" value="<?php echo htmlspecialchars($price_green); ?>" placeholder="Enter Price ...">
                          <div class="text-secondary pt-3"><?php echo $errors['price_green'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold">Select Image Green Fruit :</label>
                          <div class="input-group">
                            <input type="file" name="img_green" accept="Image/*">
                            <div class="text-secondary pt-3"><?php echo $errors['img_green'] ?></div>
                            <div class="d-flex flex-column">
                              <?php if($edit==true): ?>
                                <p class="text-secondary pt-3 mb-0"><?php echo $errors['edit_img_green'] ?></p> <br>
                                <div class="d-flex align-items-center">
                                  <p class="text-secondary font-weight-bold mr-3 ">Old Image :  </p>
                                  <img src="Upload/<?php echo $img_green ?>" alt="Image" style="width:100px; height: 100px;">
                                </div>
                              <?php endif; ?>
                            </div>
                          </div>
            ...
            <div class="row justify-content-around bs m-2">
              <div class="col-lg-2 col-xl-2">
                <?php if($update==true): ?>
                  <button name="update_green" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Update</button>
                <?php else: ?>
                  <button name="save_green" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-2 col-xl-2 bc">
                <button name="cansel_green" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Cansel</button>
              </div>
            </div>
          </form> <br><br>
        </div>
