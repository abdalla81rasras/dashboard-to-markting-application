      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseOrders" class="collapse" style="margin-top: 0.50px;" aria-labelledby="headingOrders" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="Add_Orders.php">Add Order</a>
          </div>
        </div>
      </li>
    </ul>
          ...
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputOrder">User Name :</label>
                          <input type="text" name="user_name_order" id="InputOrder" class="form-control" value="<?php echo htmlspecialchars($user_name_order); ?>" placeholder="Enter User Name ...">
                          <div class="text-secondary pt-3"><?php echo $errors['user_name_order'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                      <div class="form-group">
                          <label class="font-weight-bold" for="InputPhone">Phone Number :</label>
                          <input type="text" name="Phone_number_order" id="InputPhone" class="form-control" value="<?php echo htmlspecialchars($Phone_number_order); ?>" placeholder="Enter Phone Number ...">
                          <div class="text-secondary pt-3"><?php echo $errors['Phone_number_order'] ?></div>
                        </div>                      
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                      <div class="form-group">
                          <label class="font-weight-bold" for="InputLocation">Location :</label>
                          <input type="text" name="location_order" id="InputLocation" class="form-control" value="<?php echo htmlspecialchars($location_order); ?>" placeholder="Enter Location ...">
                          <div class="text-secondary pt-3"><?php echo $errors['location_order'] ?></div>
                        </div>                      
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputOrderName">Order Name :</label>
                          <input type="text" name="order_name_order" id="InputOrderName" class="form-control" value="<?php echo htmlspecialchars($order_name_order); ?>" placeholder="Enter Order Name ...">
                          <div class="text-secondary pt-3"><?php echo $errors['order_name_order'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="d-flex flex-row mt-2">
                            <div class="custom-control mr-5 custom-radio d-inline">
                              <input type="radio" id="customRadio1" name="Payment_Order" value="Cash" <?php if ($Payment_Order == 'Cash') echo 'checked="checked"'; ?> class="custom-control-input">
                              <label class="custom-control-label" for="customRadio1">Cash</label>
                            </div>
                            <div class="custom-control ml-5 custom-radio">
                              <input type="radio" id="customRadio2" name="Payment_Order" value="Visa" <?php if ($Payment_Order == 'Visa') echo 'checked="checked"'; ?> class="custom-control-input">
                              <label class="custom-control-label" for="customRadio2">Visa</label>
                            </div>                          
                          </div>
                        </div>
                        <div class="text-secondary pt-3"><?php echo $errors['Payment_Order'] ?></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                      <div class="form-group">
                          <label class="font-weight-bold" for="InputTotal">Total Price :</label>
                          <input type="number" name="total_price" class="form-control" id="InputTotal" value="<?php echo htmlspecialchars($total_price); ?>" placeholder="Enter Total Price ..." min="0" step="0.00001">
                          <div class="text-secondary pt-3"><?php echo $errors['total_price'] ?></div>
                        </div>                      
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputQRT">QRT :</label>
                          <input type="number" name="qrt" class="form-control" id="InputQRT" value='<?php echo htmlspecialchars($qrt); ?>' placeholder="Enter QRT ..." min="1">
                          <div class="text-secondary pt-3"><?php echo $errors['qrt'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row justify-content-around m-2">
              <div class="col-lg-2 col-xl-2">
                <?php if($update==true): ?>
                  <button name="update_orders" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Update</button>
                <?php else: ?>
                  <button name="save_orders" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-2 col-xl-2 bc">
                <button name="cansel_orders" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Cansel</button>
              </div>
            </div>
          </form> <br><br>   
        </div>
