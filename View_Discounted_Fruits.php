...
?>
      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseFruits" class="collapse" style="margin-top: 0.50px;" aria-labelledby="collapseFruits" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            <a class="collapse-item active mb-1" href="View_Discounted_Fruits.php">View Discounted Fruits</a>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="row">
            <div class="col-xl-12 col-md-12 mb-12">
              <h1 class="h3 mb-4 text-gray-800">View Discounted Fruits :</h1>
              <div class="table-responsive">
                <table class="table align-items-center table-flush">
                  ...
                  <tbody>
                      <?php 
                        $select="SELECT * FROM `discounted`";
                        $query=mysqli_query($conn , $select);
                        while($row=mysqli_fetch_assoc($query)):
                      ?>
                      <tr>
                        <td style="padding-top: 25px;"><?php echo $row['name_discounted']; ?></td>
                        <td style="padding-top: 25px;"><?php echo $row['price_discounted']; ?> JOD</td>
                        <td><img src="Upload/<?php echo $row['img_discounted'] ?>" width="55px" height="55px"></td>
                        <td style="padding-top: 25px;">
                          <a href="Add_Discounted_Fruits.php?edit_discounted=<?php echo $row['id_discounted']; ?>"><li class="fa fa-edit"></li></a> 
                          <span class="text-primary font-weight-bolder"> | </span>  
                          <a href="Add_Discounted_Fruits.php?delete_discounted=<?php echo $row['id_discounted']; ?>" ><li class="fa fa-trash"></li></a>
                        </td>
                      </tr>
                      <?php endwhile; ?>                      
                  </tbody>
