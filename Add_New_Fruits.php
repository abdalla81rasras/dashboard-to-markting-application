      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseNFRUITS" class="collapse" style="margin-top: 0.50px;" aria-labelledby="headingNFRUITS" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="Add_New_Fruits.php">Add New Fruits</a>
          </div>
        </div>
      </li>
      <li class="nav-item my-1">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputName">Name New Fruit :</label>
                          <input type="text" name="name_new" id="InputName" class="form-control" value="<?php echo htmlspecialchars($name_new); ?>" placeholder="Enter Name ...">
                          <div class="text-secondary pt-3"><?php echo $errors['name_new'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold" for="InputPrice">Price New Fruit :</label>
                          <input type="number" name="price_new" id="InputPrice" class="form-control" min="0" step="0.00001" value="<?php echo htmlspecialchars($price_new); ?>" placeholder="Enter Price ...">
                          <div class="text-secondary pt-3"><?php echo $errors['price_new'] ?></div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card h-100">
                  <div class="card-body pb-2">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="form-group">
                          <label class="font-weight-bold">Select Image New Fruit :</label>
                          <div class="input-group">
                            <input type="file" name="img_new" accept="Image/*">
                            <div class="text-secondary pt-3"><?php echo $errors['img_new'] ?></div>
                            <div class="d-flex flex-column">
                              <?php if($edit==true): ?>
                                <p class="text-secondary pt-3 mb-0"><?php echo $errors['edit_img_new'] ?></p> <br>
                                <div class="d-flex align-items-center">
                                  <p class="text-secondary font-weight-bold mr-3 ">Old Image :  </p>
                                  <img src="Upload/<?php echo $img_new ?>" alt="Image" style="width:100px; height: 100px;">
                                </div>
                              <?php endif; ?>
                            </div>
                          </div>
            ...
            <div class="row justify-content-around bs m-2">
              <div class="col-lg-2 col-xl-2">
                <?php if($update==true): ?>
                  <button name="update_new" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Update</button>
                <?php else: ?>
                  <button name="save_new" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Save</button>
                <?php endif; ?>
              </div>
              <div class="col-lg-2 col-xl-2 bc">
                <button name="cansel_new" class="btn btn-primary m-2 w-100 h-100 font-weight-bold">Cansel</button>
              </div>
            </div>
          </form> <br><br>
        </div>
