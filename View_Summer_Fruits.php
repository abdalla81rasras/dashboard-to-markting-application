...
?>
      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseSFRUITS" class="collapse" style="margin-top: 0.50px;" aria-labelledby="headingSFRUITS" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            <a class="collapse-item active mb-1" href="View_Summer_Fruits.php">View Summer Fruits</a>
        ...
        <div class="container-fluid" id="container-wrapper">
         <div class="row">
            <div class="col-xl-12 col-md-12 mb-12">
              <h1 class="h3 mb-4 text-gray-800">View Summer Fruits :</h1>
              <div class="table-responsive">
                ...
                <tbody>
                  <?php 
                    $select="SELECT * FROM `summer`";
                    $query=mysqli_query($conn , $select);
                    while($row=mysqli_fetch_assoc($query)):
                  ?>
                  <tr>
                    <td style="padding-top: 25px;"><?php echo $row['name_summer']; ?></td>
                    <td style="padding-top: 25px;"><?php echo $row['price_summer']; ?> JOD</td>
                    <td><img src="Upload/<?php echo $row['img_summer'] ?>" alt="<?php echo $row['img_summer'] ?>" width="55px" height="55px"></td>
                    <td style="padding-top: 25px;">
                      <a href="Add_Summer_Fruits.php?edit_summer=<?php echo $row['id_summer']; ?>"><li class="fa fa-edit"></li></a> 
                      <span class="text-primary font-weight-bolder"> | </span>  
                      <a href="Add_Summer_Fruits.php?delete_summer=<?php echo $row['id_summer']; ?>"><li class="fa fa-trash"></li></a>
                    </td>
                  </tr>
                  <?php endwhile; ?>                      
                </tbody>
