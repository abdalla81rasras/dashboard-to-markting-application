...
?>
      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseOrders" class="collapse" style="margin-top: 0.50px;" aria-labelledby="headingOrders" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            <a class="collapse-item active mb-1" href="View_Orders.php">View Orders</a>
            ...
            <div class="col-xl-12 col-md-12 mb-12">
              ...
              <div class="table-responsive">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                      <td style="padding-top: 10px;"><?php echo $row['user_name_order']; ?></td>
                      <td style="padding-top: 10px;"><?php echo $row['Phone_number_order']; ?></td>
                      <td style="padding-top: 10px;"><?php echo $row['location_order']; ?></td>
                      <td style="padding-top: 10px;"><?php echo $row['order_name_order']; ?></td>
                      <td style="padding-top: 10px;"><?php echo $row['Payment_Order']; ?></td>
                      <td style="padding-top: 10px;"><?php echo $row['total_price']; ?> JOD</td>
                      <td style="padding-top: 10px;"><?php echo $row['qrt']; ?></td>
                      <td style="padding-top: 10px;">
                        <a href="Add_Orders.php?edit_orders=<?php echo $row['id_orders']; ?>"><li class="fa fa-edit"></li></a> 
                        <span class="text-primary font-weight-bolder"> | </span>  
                        <a href="Add_Orders.php?delete_orders=<?php echo $row['id_orders']; ?>"><li class="fa fa-trash"></li></a>
                      </td>
                    </tr>
                    <?php endwhile; ?>                      
                  </tbody>
