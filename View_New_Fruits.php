...
?>
      ...
      <li class="nav-item active my-1">
        ...
        <div id="collapseNFRUITS" class="collapse" style="margin-top: 0.50px;" aria-labelledby="headingNFRUITS" data-parent="#accordionSidebar">
          <div class="bg-primary2-b py-2 collapse-inner rounded">
            <a class="collapse-item active mb-1" href="View_New_Fruits.php">View New Fruits</a>
        ...
        <div class="container-fluid" id="container-wrapper">
         <div class="row">
            <div class="col-xl-12 col-md-12 mb-12">
              <h1 class="h3 mb-4 text-gray-800">View New Fruits :</h1>
              <div class="table-responsive">
                <table class="table align-items-center table-flush">
                  ...
                  <tbody>
                      ...
                      ?>
                      <tr>
                        <td style="padding-top: 25px;"><?php echo $row['name_new']; ?></td>
                        <td style="padding-top: 25px;"><?php echo $row['price_new']; ?> JOD</td>
                        <td><img src="Upload/<?php echo $row['img_new'] ?>" alt="<?php echo $row['img_new'] ?>" width="55px" height="55px"></td>
                        <td style="padding-top: 25px;">
                          <a href="Add_New_Fruits.php?edit_new=<?php echo $row['id_new']; ?>"><li class="fa fa-edit"></li></a> 
                          <span class="text-primary font-weight-bolder"> | </span>  
                          <a href="Add_New_Fruits.php?delete_new=<?php echo $row['id_new']; ?>"><li class="fa fa-trash"></li></a>
                        </td>
                      </tr>
                      <?php endwhile; ?>                      
                    </tbody>
